...
public class DBColumn extends DBComponent {
	...
	public DBColumn(String name, AbstractSQLDataType sqlType, boolean primaryKey,
			boolean notNull, String editMask, String displayMask, String caption,
			String longCaption, String charset, String collate) {
	...
	public DBColumn(String name, AbstractSQLDataType sqlType, boolean primaryKey) {
		this(name, sqlType, primaryKey, primaryKey, null, null, null, null, null,
				null);
	}
	...
	public DBColumn(String name, AbstractSQLDataType sqlType, boolean primaryKey,
			boolean notNull, String editMask, String displayMask) {
		this(name, sqlType, primaryKey, notNull, editMask, displayMask, null, null,
				null, null);
	}
	 ...
	 * @param notNull
	 *          true - if this column do not be null
	 * @param charset
	 *          - encoding - charset of column
	 */
	public DBColumn(String name, AbstractSQLDataType sqlType, boolean primaryKey,
			boolean notNull, String charset) {
		this(name, sqlType, primaryKey, notNull, null, null, null, null, charset,
				null);
	}
	...
	public String getWrappedName() {
		...
		return properties.getWrappedCommands() + name
	 ...
	 * 
	 * Example:
	 * ownerTable.getColumn("empno").joinColumn(targetTable.getColumn("empno"));
	 * => CONSTRAINT fk_ownerTable_1 FOREIGN KEY empno REFERENCES
	 * targetTable(empno);
	 * 
	 * @param column
	 *          TargetColumn
	...
	public void joinColumn(DBColumn column) {
		...
		ForeignKeyConstraint fk = new ForeignKeyConstraint(getOwnerTable(), this,
				column.getOwnerTable(), column);
	...
	public String toString() {
		return getComponentName() + ": " + getName() + ";" + " SQL-Type: "
				+ sqlType.getSyntax() + ", PK: " + isPrimaryKey() + ", isNotNull: "
				+ isNotNull() + ", editMask: " + getEditMask() + ", displayMask: "
				+ getDisplayMask() + ", caption: " + getCaption() + ", longCaption: "
				+ getLongCaption();
	}
