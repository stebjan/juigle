 ...
 */
public class JUIGLELoginPane extends JXPanel {
     ...
     */
    static {
        LookAndFeelAddons.contribute(new JUIGLELoginPaneAddon());
    }
     ...
     */
    public JUIGLELoginPane(LoginService service) {
     ...
     */
    public JUIGLELoginPane(LoginService service, PasswordStore passwordStore, UserNameStore userStore) {
     ...
     */
    public JUIGLELoginPane(LoginService service, PasswordStore passwordStore, UserNameStore userStore, List<String> servers) {
    ...
    private Window getTLA() {
        Container c = JUIGLELoginPane.this;
...
//            add(contentPanel, BorderLayout.CENTER);
    ...
    private static final class LoginAction extends AbstractActionExt {
        ...
        private JUIGLELoginPane panel;
        public LoginAction(JUIGLELoginPane p) {
    ...
    private static final class CancelAction extends AbstractActionExt {
        ...
        private JUIGLELoginPane panel;
        public CancelAction(JUIGLELoginPane p) {
    ...
    public static Status showLoginDialog(Component parent, LoginService svc, PasswordStore ps, UserNameStore us, List<String> servers) {
    	JUIGLELoginPane panel = new JUIGLELoginPane(svc, ps, us, servers);
     ...
     * @return The status of the login operation
     */
    public static Status showLoginDialog(Component parent, JUIGLELoginPane panel) {
    ...
    /**
     */
    public static JXLoginFrame showLoginFrame(JUIGLELoginPane panel) {
    ...
    public static final class JXLoginDialog extends JDialog {
        ...
        public JXLoginDialog(Frame parent, JUIGLELoginPane p) {
            super(parent, true);
            init(p);
        }

        public JXLoginDialog(Dialog parent, JUIGLELoginPane p) {
            super(parent, true);
            init(p);
        }

        protected void init(JUIGLELoginPane p) {
            setTitle(UIManagerExt.getString(CLASS_NAME + ".titleString", getLocale()));
            this.panel = p;
            initWindow(this, panel);
        }
    
        public JUIGLELoginPane.Status getStatus() {
    ...
    public static final class JXLoginFrame extends JXFrame {
        ...
        public JXLoginFrame(JUIGLELoginPane p) {
	...
	public JXPanel getContentPane() {
        ...
        public JUIGLELoginPane getPanel() {
            return panel;
        }
    }
     ...
     * removed.
     */
    static void initWindow(final Window w, final JUIGLELoginPane panel) {
        ...
        cancelButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                panel.status = JUIGLELoginPane.Status.CANCELLED;
                w.setVisible(false);
                w.dispose();
            }
        });
                ...
                public void run() {
                    if (!tested) {
                        ...
                        if (retry < 3) {
                            ...
                            Window w = JUIGLELoginPane.this.getTLA();
                            if (w != null) {
                                w.toFront();
                            }
                            cot.runTest();
